                    ...
                    <div className="flex flex-col md:flex-row justify-around items-center">
                        ...
                        <div className=" mt-6 space-y-3 lg:space-y-0 ">
                            ...
                            <input
                                    id="email"
                                    type="email"
                                    className="px-4 py-2 text-gray-700 bg-white border  dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 "
                                    placeholder="Email Address"
                                />
                                <button
                                    className="w-full px-5 py-2 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-[#cfaf45] lg:w-auto lg:mx-4 hover:bg-transparent focus:outline-none focus:bg-blue-500"
                                >
                                    Subscribe
                                </button>
                            </div>
